...
export class BasicOperationsAdditionComponent implements OnInit, OnDestroy {
  ...
  onGetLevelGameResult(GameSessionId: string) {
    this._levelGameResultSvc.LoadbasicOperationsAddGameResultAndRating(GameSessionId);
