...
@Component({
  selector: 'app-basic-operations-division',
  templateUrl: './basic-operations-division.component.html',
  styleUrls: ['./basic-operations-division.component.scss']
})
export class BasicOperationsDivisionComponent implements OnInit, OnDestroy {
  ...
  onGetLevelGameResult(GameSessionId: string) {
    this._levelGameResultSvc.LoadbasicOperationsDivisionGameResultAndRating(GameSessionId);
