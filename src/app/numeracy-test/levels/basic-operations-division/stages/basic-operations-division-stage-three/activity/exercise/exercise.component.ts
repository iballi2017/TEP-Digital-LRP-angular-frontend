...
export class ExerciseComponent implements OnInit, OnDestroy {
  ...
  getActionNumbers() {
    let numbersList =
      this._basicOperationsDivisionStageThreeSvc.GetActionNumbers();
  ...
  getresultNumbers() {
    ...
    let numbersList =
      this._basicOperationsDivisionStageThreeSvc.GetResultNumbers();
    this.resultNumbers = numbersList;
  ...
  onSubmit(Payload: any) {
    ...
    let subscription =   this._basicOperationsDivisionStageThreeSvc
