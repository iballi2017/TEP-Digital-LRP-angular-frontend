...
export class ExerciseComponent implements OnInit, OnDestroy {
  ...
  getActionNumbers() {
    let numbersList =
      this._basicOperationsDivisionStageOneSvc.GetActionNumbers();
  ...
  getresultNumbers() {
    ...
    let numbersList =
      this._basicOperationsDivisionStageOneSvc.GetresultNumbers();
    this.resultNumbers = numbersList;
  ...
  onSubmitSimpleExercise(answer: string, isRoute: boolean) {
    ...
    let subscription = this._basicOperationsDivisionStageOneSvc
