...
import { BasicOperationsSubtractionService } from 'src/app/services/basic-operations/basic-operations-subtraction.service';
...
export class ExerciseComponent implements OnInit {
  ...
  constructor(
    private _basicOperationsDivisionSvc: BasicOperationsSubtractionService,
