...
export class BasicOperationsSubtractionComponent implements OnInit, OnDestroy {
  ...
  onGetLevelGameResult(GameSessionId: string) {
    this._levelGameResultSvc.LoadbasicOperationsSubtractionGameResultAndRating(GameSessionId);
