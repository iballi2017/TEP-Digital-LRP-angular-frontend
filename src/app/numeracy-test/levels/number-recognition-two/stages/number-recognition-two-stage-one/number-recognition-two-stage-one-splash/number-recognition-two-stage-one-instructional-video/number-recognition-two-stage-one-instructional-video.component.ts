...
@Component({
  ...
  templateUrl:
    './number-recognition-two-stage-one-instructional-video.component.html',
  styleUrls: [
    './number-recognition-two-stage-one-instructional-video.component.scss',
  ],
})
export class NumberRecognitionTwoStageOneInstructionalVideoComponent
  implements OnInit {
    ngOnInit(): void {
