...
export class BasicOperationsMultiplicationComponent implements OnInit, OnDestroy {
  ...
  onGetLevelGameResult(GameSessionId: string) {
    this._levelGameResultSvc.LoadbasicOperationsMultiplicationGameResultAndRating(GameSessionId);
