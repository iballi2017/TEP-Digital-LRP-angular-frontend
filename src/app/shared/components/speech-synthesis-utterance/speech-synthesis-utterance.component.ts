...
@Component({
  selector: 'app-speech-synthesis-utterance',
  templateUrl: './speech-synthesis-utterance.component.html',
  styleUrls: ['./speech-synthesis-utterance.component.scss'],
})
export class SpeechSynthesisUtteranceComponent
